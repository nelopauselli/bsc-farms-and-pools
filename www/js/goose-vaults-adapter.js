function GooseVaultsAdapter(address) {
    this.address = address;
    this.abi = gooseVaultAbi;
    ...
    this.init = () => {
        ...
        return this.contract.methods.poolLength()
            ...
            .then(value => {
                ...
                return this.contract.methods.gooseDollar().call()
            })
    ...
    this.getPendingReward = (pid, address) => {
        return this.contract.methods.pendingRewards(pid, address)
            .call()
            .then(value => {
